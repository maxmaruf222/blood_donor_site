                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="added.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="name" type="text" placeholder="Example:max Den" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Example: max20</p>
                                        </div>
...
<footer>
        <p>&copy; <?php echo date("Y"); ?>: Developed By Maruf Hassan</p>
    </footer>
